 ...
 */
function createMiddleware(router, validator, options) {
  /**
 ...
 * @param options.validator {function(object, Schema)}
...
module.exports = function koaSwaggerFactory(def, options) {
  ...
  var router = genRouter(flatDef, options || {});

  // Return the middleware
  return createMiddleware(router, validator, options || {});
};
